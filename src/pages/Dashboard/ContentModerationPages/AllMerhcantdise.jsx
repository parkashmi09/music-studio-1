...
const AllMerchandise = () => {
  // Dummy data for merchandise items (corrected to avoid duplicates and match structure)
  const merchandiseItems = [
    {
      id: 1,
      image: '/images/merchandise/first.png',
      title: 'Merchandise Item 1',
      artist: 'Artist Name',
      created: '11/02/2025',
    },
    {
  ...
  return (
    <div className="">
      <div className="flex items-center justify-between mb-2">
        <h1 className="text-white text-2xl font-orbitron">Merchandise For Review</h1>
            ...
            >
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="bg-white bg-opacity-20 backdrop-blur-sm absolute bottom-0 left-0 right-0 p-2 flex justify-between items-center">
                  <div className="">
                    <p className="text-[12px] font-medium text-white">{item.artist}</p>
                    <p className="text-[10px] text-gray-200">Created on: {item.created}</p>
                  </div>
