...
const AllMusic = () => {
  // Dummy data for music items (corrected to avoid duplicates and match structure)
  const musicItems = [
    {
      id: 1,
  ...
  return (
    <div className="">
      <div className="flex items-center justify-between mb-2">
        <h1 className="text-white text-2xl font-orbitron">Music For Review</h1>
      ...
      <div className="mb-12 bg-gradient-to-b from-[rgba(6,11,40,0.74)] to-[rgba(10,14,35,0.71)] rounded-[6px] px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate("/dashboard/all-music")}
